...
export default function RegisterPage() {
  const { user, signUpEmail, signInGoogle, firebaseConfigured } = useAuth();
  ...
  return (
    <AuthShell
      ...
      subtitle="Start planning your perfect day — it takes under a minute."
    >
      {!firebaseConfigured && (
